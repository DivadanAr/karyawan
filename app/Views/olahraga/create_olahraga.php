        ...
        <div class="row">
            ...
            <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Tambah olahraga</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="card" style="padding-bottom: 20px;">
                <div class="card-header">
                    <h4>Tambah olahragaa</h4>
                    <p class="f-m-light mt-1">Pastikan semua terisi dengan benar!</p>
                </div>
                <div class="row m-2 mx-4">
                    <form action="<?php echo base_url('olahraga/store') ?>" method="POST">
                        <div class="col-12">
                            <label class="form-label" for="name_olahraga">Nama olahraga</label>
                            <input class="form-control" id="name_olahraga" name="nama_olahraga" type="text" placeholder="name olahraga" aria-label="name_olahraga" required>
                        </div>
