        ...
        <div class="row">
            ...
            <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Detail makanan</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="card" style="padding-bottom: 20px;">
                <div class="card-header">
                    <h4>Detail makanana</h4>
                    <p class="f-m-light mt-1">Pastikan semua terisi dengan benar!</p>
                </div>
                <div class="row m-2 mx-4">
                    <form action="<?php echo base_url('makanan/update/' . $makanan['id']) ?>" method="POST">
                        <div class="col-12">
                            <label class="form-label" for="name_makanan">Nama makanan</label>
                            <input class="form-control" id="name_makanan" name="nama_makanan" type="text" placeholder="name makanan" aria-label="name_makanan" required value="<?= $makanan['nama_makanan'] ?>" disabled>
                        </div>
