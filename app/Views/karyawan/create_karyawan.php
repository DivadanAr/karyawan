        ...
        <div class="col-sm-12">
            <div class="card height-equal">
                ...
                <div class="card-body custom-input">
                    <form class="row g-3" action="<?= base_url('karyawan/store') ?>" method="POST">
                        <div class="col-12">
                            <label class="form-label" for="name">Nama</label>
                            <input class="form-control" id="name" type="text" placeholder="name" aria-label="name" name="nama" required>
                        </div>
                        <div class="col-12">
                            <label class="form-label" for="nip">NIP</label>
                            <input class="form-control" id="nip" type="text" placeholder="nip" aria-label="nip" name="nip" required>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group flatpicker-calender">
                                <input class="form-control" id="human-friendly" type="date" name="tanggal_lahir">
                            </div>
                        </div>
                        <div class="col-12">
                            <label class="form-label" for="nomor_telepon">Nomor Telepon</label>
                            <input class="form-control" id="nomor_telepon" name="nomor_telepon" type="text" placeholder="nomor_telepon" aria-label="nomor_telepon" required>
                        </div>
                        <div class="col-12">
