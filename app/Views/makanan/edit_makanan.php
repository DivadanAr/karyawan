                ...
                <div class="row m-2 mx-4">
                    <form action="<?php echo base_url('makanan/update/' . $makanan['id']) ?>" method="POST">
                        <div class="col-12">
                            ...
                            <input class="form-control" id="name_makanan" name="nama_makanan" type="text" placeholder="name makanan" aria-label="name_makanan" required value="<?= $makanan['nama_makanan'] ?>">
                        </div>
