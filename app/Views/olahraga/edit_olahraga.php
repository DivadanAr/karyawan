        ...
        <div class="row">
            ...
            <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit olahraga</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="row m-2 mx-4">
                    <form action="<?php echo base_url('olahraga/update/' . $olahraga['id']) ?>" method="POST">
                        <div class="col-12">
                            ...
                            <input class="form-control" id="name_olahraga" name="nama_olahraga" type="text" placeholder="name olahraga" aria-label="name_olahraga" required value="<?= $olahraga['nama_olahraga'] ?>">
                        </div>
