                ...
                <div class="card-body custom-input">
                    <form class="row g-3" action="" method="POST">
                        <div class="col-12">
                            ...
                            <input disabled class="form-control" id="name" type="text" placeholder="name" aria-label="name" name="nama" value="<?= $karyawan['nama'] ?>" required>
                        </div>
                        <div class="col-12">
                            <label class="form-label" for="nip">NIP</label>
                            <input disabled class="form-control" id="nip" type="text" placeholder="nip" aria-label="nip" name="nip" value=" <?= $karyawan['nip'] ?>" required>
                        </div>
                        <div class="col-12">
                            <label class="form-label" for="validationDefault04">Jenis Kelamin</label>
                            <select disabled class="form-select" id="validationDefault04" required="" name="jenis_kelamin">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group flatpicker-calender">
                                <input disabled class="form-control" id="human-friendly" type="date" name="tanggal_lahir" value="<?= $karyawan["tanggal_lahir"] ?>">
                            </div>
                        </div>
                        <div class="col-12">
                            <label class="form-label" for="nomor_telepon">Nomor Telepon</label>
                            <input disabled class="form-control" id="nomor_telepon" name="nomor_telepon" type="text" placeholder="nomor telepon" aria-label="nomor_telepon" required value="<?= $karyawan["nomor_telepon"] ?>">
                        </div>
                        <div class="col-12">
                            <label class="form-label" for="alamat">Alamat</label>
                            <textarea disabled class="form-control" id="alamat" rows="3" name="alamat"><?= $karyawan["alamat"] ?></textarea>
                        </div>
                        <div class="col-12">
                            <label class="form-label" for="alamat">Makanan Favourit</label>
                            <select disabled id="mySelectMakanan" multiple name="makanan[]">
                        ...
                        <div class="col-12">
                            ...
                            <select disabled id="mySelectOlahraga" multiple name="olahraga[]">
                        ...
                        <div class="col-12">
                            <a href="<?= base_url('karyawan/edit/' . $karyawan['id']) ?>">
